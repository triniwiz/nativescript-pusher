...
declare class PTPusher extends NSObject implements PTPusherConnectionDelegate, PTPusherEventBindings {

	static alloc(): PTPusher; // inherited from NSObject

	static new(): PTPusher; // inherited from NSObject

	static pusherWithKeyDelegate(key: string, delegate: PTPusherDelegate): PTPusher;

	static pusherWithKeyDelegateEncrypted(key: string, delegate: PTPusherDelegate, isEncrypted: boolean): PTPusher;

	static pusherWithKeyDelegateEncryptedCluster(key: string, delegate: PTPusherDelegate, isEncrypted: boolean, cluster: string): PTPusher;
	...
	bindToEventNamedHandleWithBlock(eventName: string, block: (p1: PTPusherEvent) => void): PTPusherEventBinding;

	bindToEventNamedHandleWithBlockQueue(eventName: string, block: (p1: PTPusherEvent) => void, queue: NSObject): PTPusherEventBinding;

	bindToEventNamedTargetAction(eventName: string, target: any, selector: string): PTPusherEventBinding;
	...
	pusherConnectionDidDisconnectWithCodeReasonWasClean(connection: PTPusherConnection, errorCode: number, reason: string, wasClean: boolean): void;

	pusherConnectionDidFailWithErrorWasConnected(connection: PTPusherConnection, error: NSError, wasConnected: boolean): void;

	pusherConnectionDidReceiveEvent(connection: PTPusherConnection, event: PTPusherEvent): void;
	...
	subscribeToPresenceChannelNamedDelegate(name: string, presenceDelegate: PTPusherPresenceChannelDelegate): PTPusherPresenceChannel;
...
declare class PTPusherAPI extends NSObject {
	...
	initWithKeyAppIDSecretKey(aKey: string, anAppID: string, aSecretKey: string): this;

	triggerEventOnChannelDataSocketID(eventName: string, channelName: string, eventData: any, socketID: string): void;
}

declare class PTPusherChannel extends NSObject implements PTEventListener, PTPusherEventBindings {
...
interface PTPusherChannelAuthorizationDelegate extends NSObjectProtocol {
	...
	pusherChannelRequiresAuthorizationForSocketIDCompletionHandler(channel: PTPusherChannel, socketID: string, completionHandler: (p1: boolean, p2: NSDictionary<any, any>, p3: NSError) => void): void;
}
...
declare class PTPusherChannelAuthorizationOperation extends PTURLRequestOperation {
	...
	static operationWithAuthorizationURLChannelNameSocketID(URL: NSURL, channelName: string, socketID: string): any;
...
declare class PTPusherChannelServerBasedAuthorization extends NSObject implements PTPusherChannelAuthorizationDelegate {
	...
	customizeOperationsWithBlock(requestBlock: (p1: PTPusherChannelAuthorizationOperation, p2: PTPusherChannel) => void): void;
...
interface PTPusherDelegate extends NSObjectProtocol {
	...
	pusherConnectionWillAutomaticallyReconnectAfterDelay?(pusher: PTPusher, connection: PTPusherConnection, delay: number): boolean;

	pusherConnectionWillConnect?(pusher: PTPusher, connection: PTPusherConnection): boolean;

	pusherDidFailToSubscribeToChannelWithError?(pusher: PTPusher, channel: PTPusherChannel, error: NSError): void;

	pusherDidReceiveErrorEvent?(pusher: PTPusher, errorEvent: PTPusherErrorEvent): void;

	pusherDidSubscribeToChannel?(pusher: PTPusher, channel: PTPusherChannel): void;

	pusherDidUnsubscribeFromChannel?(pusher: PTPusher, channel: PTPusherChannel): void;

	pusherWillAuthorizeChannelWithAuthOperation?(pusher: PTPusher, channel: PTPusherChannel, operation: PTPusherChannelAuthorizationOperation): void;
}
...
declare class PTPusherErrorEvent extends PTPusherEvent {
	...
	static eventFromMessageDictionary(dictionary: NSDictionary<any, any>): PTPusherErrorEvent; // inherited from PTPusherEvent
...
declare class PTPusherEvent extends NSObject {
	...
	static eventFromMessageDictionary(dictionary: NSDictionary<any, any>): PTPusherEvent;
...
declare class PTPusherEventBinding extends NSObject implements PTEventListener {
	...
	initWithEventListenerEventName(eventListener: PTEventListener, eventName: string): this;
...
declare class PTPusherEventDispatcher extends NSObject implements PTEventListener {
	...
	addEventListenerForEventNamed(listener: PTEventListener, eventName: string): PTPusherEventBinding;
...
declare class PTPusherMockConnection extends PTPusherConnection {
	...
	simulateServerEventNamedDataChannel(name: string, data: any, channelName: string): void;
...
declare class PTPusherPresenceChannel extends PTPusherPrivateChannel {
	...
	static channelWithNamePusher(name: string, pusher: PTPusher): PTPusherPresenceChannel; // inherited from PTPusherChannel
...
declare class PTPusherPrivateChannel extends PTPusherChannel {
	...
	static channelWithNamePusher(name: string, pusher: PTPusher): PTPusherPrivateChannel; // inherited from PTPusherChannel
...
declare class PTURLRequestOperation extends NSOperation implements NSURLSessionDataDelegate, NSURLSessionDelegate {
