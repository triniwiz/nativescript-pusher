...
declare class NativePusher extends NSObject {
	...
	setSubscriptionsWithInterests(interests: NSArray<string>): void;
...
interface PusherDelegate {
	...
	failedToRegisterForPushNotificationsWithResponseResponseBody?(response: NSURLResponse, responseBody: string): void;
	...
	subscribedToInterestsWithInterests?(interests: NSArray<string>): void;
